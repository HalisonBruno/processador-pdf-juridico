...
Além de economizar tokens junto ao agente de IA, realiza o pré-processamento com OCR e remove ruídos como assinatura eletrônica, cabeçalhos e rodapés, contribuindo para maior concentração do agente no conteúdo jurídico do documento.
